...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "model.Flag": {
            ...
            "properties": {
                "banned": {
                    "description": "Whether the flag is banned. If banned, the user who submitted the flag will be judged as cheating.",
                    "type": "boolean"
                },
                "challenge": {
        ...
        "model.Submission": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "The status of the submission. (0-meaningless, 1-accepted, 2-incorrect, 3-cheat, 4-invalid(duplicate, etc.))",
                    "type": "integer"
                },
                "team": {
