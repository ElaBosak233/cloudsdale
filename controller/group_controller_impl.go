...
func (c *GroupControllerImpl) Create(ctx *gin.Context) {
...
func (c *GroupControllerImpl) Update(ctx *gin.Context) {
	utils.Logger.WithFields(logrus.Fields{
		"ClientIP": ctx.ClientIP(),
	}).Info("Group 数据表记录更新")
...
func (c *GroupControllerImpl) Delete(ctx *gin.Context) {
	utils.Logger.WithFields(logrus.Fields{
		"ClientIP": ctx.ClientIP(),
	}).Info("Group 数据表记录删除")
	id := ctx.Param("id")
...
func (c *GroupControllerImpl) FindById(ctx *gin.Context) {
	utils.Logger.WithFields(logrus.Fields{
		"ClientIP": ctx.ClientIP(),
...
func (c *GroupControllerImpl) FindAll(ctx *gin.Context) {
	utils.Logger.WithFields(logrus.Fields{
		"ClientIP": ctx.ClientIP(),
	}).Info("Group 数据表记录全查询")
