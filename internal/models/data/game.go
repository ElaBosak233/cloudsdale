...
type Game struct {
	...
	MemberLimitMin         int    `xorm:"'member_limit_min' notnull default(1)" json:"member_limit_min"`                 // 比赛人数最小值
	MemberLimitMax         int    `xorm:"'member_limit_max' default(10)" json:"member_limit_max"`                        // 比赛人数最大值
	ParallelContainerLimit int    `xorm:"'parallel_container_limit' notnull default(2)" json:"parallel_container_limit"` // 容器并行限制
