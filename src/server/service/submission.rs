...
pub async fn find(
    ...
    let (mut submissions, total) = crate::repository::submission::find(
        req.id,
        req.user_id,
        req.team_id,
        req.game_id,
...
pub async fn create(
    ...
    let (challenges, _) =
        crate::repository::challenge::find(req.challenge_id, None, None, None, None, None, None)
            .await
            .unwrap();
    ...
    let mut submission = crate::repository::submission::create(req.clone().into())
        .await
        .unwrap()
        .into_active_model();

    let (exist_submissions, total) = crate::repository::submission::find(
        None,
        None,
        None,
        req.game_id,
    ...
    match challenge.is_dynamic {
        true => {
            ...
            let (pods, _) = crate::repository::pod::find(
                None,
                None,
                None,
                None,
    ...
    let submission = crate::repository::submission::update(submission)
        .await
        .unwrap();
