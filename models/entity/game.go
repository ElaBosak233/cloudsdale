...
type Game struct {
	GameID                 int64     `xorm:"'id' pk autoincr" json:"id"`                                                    // The game's id. As primary key.
	Type                   string    `xorm:"'type' varchar(16) default('jeopardy')" json:"type"`                            // The game's type. (Such as "jeopardy"/"awd")
