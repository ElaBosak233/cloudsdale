...
type Category struct {
	...
	Mdi         string    `xorm:"'mdi' varchar(16) default('fingerprint')" json:"mdi"` // The category's icon. (Based on Material Design Icons, Reference site: https://pictogrammers.com/library/mdi/) (Such as "fingerprint": https://pictogrammers.com/library/mdi/icon/fingerprint/)
