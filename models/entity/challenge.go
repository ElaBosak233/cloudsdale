...
type Challenge struct {
	...
	Title         string    `xorm:"'title' nvarchar(32) notnull" json:"title"`                          // 题目标题
	...
	Flag          string    `xorm:"'flag' varchar(128)" json:"flag,omitempty"`                          // Flag 字符串（静态）
	...
	CpuLimit      float64   `xorm:"'cpu_limit' default(1)" json:"cpu_limit,omitempty"`                  // CPU限制（核）
	MemoryLimit   int64     `xorm:"'memory_limit' default(256)" json:"memory_limit,omitempty"`          // 内存限制（MB）
	Duration      int64     `xorm:"'duration' default(1800)" json:"duration,omitempty"`                 // 维持时间（秒）
	Difficulty    int64     `xorm:"'difficulty' default(1)" json:"difficulty"`                          // 难度系数（1~5）
	PracticePts   int64     `xorm:"'practice_pts' default(200) notnull" json:"practice_pts"`            // 练习得分
