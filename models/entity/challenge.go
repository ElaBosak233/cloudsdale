...
type Challenge struct {
	ID            int64        `xorm:"'id' pk autoincr" json:"id"`                                         // The challenge's id. As primary key.
	...
	Category      *Category    `xorm:"-" json:"category,omitempty"`
	Flags         []Flag       `xorm:"-" json:"flags,omitempty"`
	Hints         []Hint       `xorm:"-" json:"hints,omitempty"`
	Images        []Image      `xorm:"-" json:"images,omitempty"`
	Submissions   []Submission `xorm:"-" json:"submissions,omitempty"`
	IsSolved      bool         `xorm:"-" json:"is_solved,omitempty"`
