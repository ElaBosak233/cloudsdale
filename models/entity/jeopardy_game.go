...
type JeopardyGame struct {
	JeopardyGameID         int64   `xorm:"'id' pk autoincr" json:"id"`                                                    // The jeopardy game's id.
	GameID                 int64   `xorm:"'game_id'" json:"gameID"`                                                       // The game which is related to this jeopardy game.
